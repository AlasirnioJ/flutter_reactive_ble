...
class AutoPairDeviceRequest extends $pb.GeneratedMessage {
  factory AutoPairDeviceRequest({
    $core.String? deviceId,
    $core.String? pin,
  }) {
    final $result = create();
  ...
  AutoPairDeviceRequest._() : super();
  factory AutoPairDeviceRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AutoPairDeviceRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AutoPairDeviceRequest', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'deviceId', protoName: 'deviceId')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AutoPairDeviceRequest clone() => AutoPairDeviceRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoPairDeviceRequest copyWith(void Function(AutoPairDeviceRequest) updates) => super.copyWith((message) => updates(message as AutoPairDeviceRequest)) as AutoPairDeviceRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AutoPairDeviceRequest create() => AutoPairDeviceRequest._();
  AutoPairDeviceRequest createEmptyInstance() => create();
  static $pb.PbList<AutoPairDeviceRequest> createRepeated() => $pb.PbList<AutoPairDeviceRequest>();
  @$core.pragma('dart2js:noInline')
  static AutoPairDeviceRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AutoPairDeviceRequest>(create);
  static AutoPairDeviceRequest? _defaultInstance;
...
class AutoPairDeviceResult extends $pb.GeneratedMessage {
  factory AutoPairDeviceResult({
    $core.bool? result,
  }) {
    final $result = create();
    if (result != null) {
  ...
  AutoPairDeviceResult._() : super();
  factory AutoPairDeviceResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AutoPairDeviceResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AutoPairDeviceResult', createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AutoPairDeviceResult clone() => AutoPairDeviceResult()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoPairDeviceResult copyWith(void Function(AutoPairDeviceResult) updates) => super.copyWith((message) => updates(message as AutoPairDeviceResult)) as AutoPairDeviceResult;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AutoPairDeviceResult create() => AutoPairDeviceResult._();
  AutoPairDeviceResult createEmptyInstance() => create();
  static $pb.PbList<AutoPairDeviceResult> createRepeated() => $pb.PbList<AutoPairDeviceResult>();
  @$core.pragma('dart2js:noInline')
  static AutoPairDeviceResult getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AutoPairDeviceResult>(create);
  static AutoPairDeviceResult? _defaultInstance;
