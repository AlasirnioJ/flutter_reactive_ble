...
@$core.Deprecated('Use autoPairDeviceRequestDescriptor instead')
const AutoPairDeviceRequest$json = {
  '1': 'AutoPairDeviceRequest',
  '2': [
    {'1': 'deviceId', '3': 1, '4': 1, '5': 9, '10': 'deviceId'},
...
/// Descriptor for `AutoPairDeviceRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List autoPairDeviceRequestDescriptor = $convert.base64Decode(
    'ChVBdXRvUGFpckRldmljZVJlcXVlc3QSGgoIZGV2aWNlSWQYASABKAlSCGRldmljZUlkEhAKA3'
    'BpbhgCIAEoCVIDcGlu');
...
@$core.Deprecated('Use autoPairDeviceResultDescriptor instead')
const AutoPairDeviceResult$json = {
  '1': 'AutoPairDeviceResult',
  '2': [
    {'1': 'result', '3': 1, '4': 1, '5': 8, '10': 'result'},
  ],
};

/// Descriptor for `AutoPairDeviceResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List autoPairDeviceResultDescriptor = $convert.base64Decode(
    'ChRBdXRvUGFpckRldmljZVJlc3VsdBIWCgZyZXN1bHQYASABKAhSBnJlc3VsdA==');
